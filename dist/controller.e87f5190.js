...
var View = exports.default = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function update(data) {
      ...
      var newElement = Array.from(newDOM.querySelectorAll('*'));
      var curElement = Array.from(this._parentEl.querySelectorAll('*'));
      // console.log(newElement);
      // console.log(curElement);

      newElement.forEach(function (newEl, i) {
        var _newEl$firstChild;
        var curEl = curElement[i];
...
var RecipeView = /*#__PURE__*/function (_View) {
  ...
  _createClass(RecipeView, [{
    ...
    key: "_renderIngredient",
    value: function _renderIngredient(ing) {
...
var RES_PER_PAGE = exports.RES_PER_PAGE = 15;
var KEY = exports.KEY = 'ed8ed486-9f90-4060-818f-bdafe018762b';
var MODAL_CLOSE_SEC = exports.MODAL_CLOSE_SEC = 2;
...
exports.uploadRecipe = exports.updateServings = exports.state = exports.loadSearchResults = exports.loadRecipe = exports.getSearchResultsPage = exports.deleteBookmarks = exports.addBookmarks = void 0;
var _config = require("./config.js");
...
var addBookmarks = exports.addBookmarks = function addBookmarks(recipe) {
  // Add bookmark
...
var deleteBookmarks = exports.deleteBookmarks = function deleteBookmarks(id) {
  // Delete Bookmarked
...
},{"./config.js":"src/js/config.js","./helper.js":"src/js/helper.js"}],"src/js/views/SearchView.js":[function(require,module,exports) {
"use strict";
...
var PaginationView = /*#__PURE__*/function (_View) {
  ...
  _createClass(PaginationView, [{
    ...
    key: "_generateMarkup",
    value: function _generateMarkup() {
      var numPage = Math.ceil(this._data.results.length / this._data.resultsPerPage);
      ...
      if (curPage > 1 && curPage < numPage) {
        return "\n        ".concat(this._generatePerviousBtn(curPage), "\n        ").concat(this._generateNextBtn(curPage), "\n      ");
      }
    ...
    key: "_generatePerviousBtn",
    value: function _generatePerviousBtn(curPage) {
      return "\n          <button data-goto=\"".concat(curPage - 1, "\"\n           class=\"btn--inline pagination__btn--prev\">\n            <svg class=\"search__icon\">\n              <use href=\"").concat(_icons.default, "#icon-arrow-left\"></use>\n            </svg>\n            <span>Page ").concat(curPage - 1, "</span>\n          </button>\n      ");
    }
  }, {
    key: "_generateNextBtn",
    value: function _generateNextBtn(curPage) {
...
var controlPagination = function controlPagination(goto) {
...
init();
},{"./views/recipeView.js":"src/js/views/recipeView.js","./model.js":"src/js/model.js","./views/SearchView.js":"src/js/views/SearchView.js","./views/resultsView.js":"src/js/views/resultsView.js","./views/paginationView.js":"src/js/views/paginationView.js","./views/bookmarksView.js":"src/js/views/bookmarksView.js","./views/addRecipeView.js":"src/js/views/addRecipeView.js","./config.js":"src/js/config.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
